...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   map_validation_aux_bonus.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aherrero <aherrero@student.42urduliz.co    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/28 17:57:24 by bgarrido          #+#    #+#             */
/*   Updated: 2022/08/14 13:40:31 by aherrero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_check_invalid_chars(int i, int j, char **lines)
{
	if (lines[i][j] != ' ' && lines[i][j] != '0' && lines[i][j] != '1'
			...
			&& lines[i][j] != 'E' && lines[i][j] != 'W' && lines[i][j] != 'K')
		return (1);
	return (0);
}
